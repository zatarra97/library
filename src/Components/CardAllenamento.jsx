            ...
            <div className="flex space-x-4 items-center justify-center mt-5">
                <div className="">
                    <div className="rounded-full bg-blue-500 p-1">
                        <svg className="text-white w-6" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        ...
                        <tr class="bg-white dark:bg-gray-800">
                            ...
                            <td class="px-3 py-2">
                                <div className="rounded-full bg-blue-500 p-1 w-7">
                                    <svg className="text-white" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
